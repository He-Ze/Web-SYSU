...
<html>
	...
	<body>
		...
		<% 
			...
			String filename = "";
			String address = "http://172.18.187.251:8080/testjsp/temp/files/";
			if (isMultipart) {
				...
				for (int i = 0; i < items.size(); i++) {
					...
					if (fi.isFormField()) {
						...
						if (!dfi.getName().trim().equals("")) {
							...
							String fileName = application.getRealPath("files")+ System.getProperty("file.separator")+ FilenameUtils.getName(dfi.getName());
