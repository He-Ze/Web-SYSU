	...
	try{
		if(request.getParameter("sub") != null){
			...
			while(rs.next()) {
				...
				table.append("<td>");
				String url1 = "updateStu18340052.jsp?pid=" + rs.getString("id");
				table.append("<a href='" + url1 + "'>修改</a> ");
				String url2 = "deleteStu18340052.jsp?pid=" + rs.getString("id");
...
<html  lang="zh-cn">
	...
	<body>
		<div class="container">
			<h1>查询学生名单</h1>
			<form action="queryStu18340052.jsp" method="post" name="f">
			...
			<div class="add">
				<br><br>
				<a href="addStu18340052.jsp">新增</a>
				<a href="browseStu18340052.jsp">返回</a>
				<br><br>
			</div>
		</div>
	</body>
